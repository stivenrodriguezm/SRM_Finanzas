...
function SettingRow({ icon, iconBg, iconColor, title, subtitle, onPress, rightElement }) {
...
export default function ProfileScreen() {
  ...
  // ── Modal información personal (tarea 2) ────────────────
  ...
  const themeLabel = { light: 'Claro', dark: 'Oscuro', adaptive: 'Sistema' };

  return (
    <SafeAreaView style={styles.safeArea}>
      <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>

        {/* ── Avatar y datos del usuario (tarea 1: sin planBadge) ── */}
        ...
        <View style={styles.group}>
          {/* Tarea 2: Información Personal → abre modal editable */}
          <SettingRow
            icon="person-outline"
            iconBg="#EFF6FF"
            iconColor="#3B82F6"
        ...
        <View style={styles.group}>
          <SettingRow
            ...
            subtitle={`Tema: ${themeLabel[preferences.theme]} · Privacidad por sección`}
            onPress={() => navigation.navigate('Preferences')}
          />
        </View>

        {/* ── Cerrar Sesión (tarea 1: sin sección Soporte) ── */}
        <TouchableOpacity
      ...
      <Modal visible={isPwModalVisible} animationType="slide" transparent={true}>
        <View style={styles.modalOverlay}>
          ...
          >
            ...
            <TouchableOpacity style={styles.saveButton} onPress={handleSavePw}>
